...
Scheduled::Route.create(name: '5', internal_id: '5', color: '00933c')
Scheduled::Route.create(name: '6', internal_id: '6', color: '00933c')
Scheduled::Route.create(name: '6X', internal_id: '6X', color: '00933c', visible: false)
Scheduled::Route.create(name: '7', internal_id: '7', color: 'b933ad')
Scheduled::Route.create(name: '7X', internal_id: '7X', color: 'b933ad', visible: false)
Scheduled::Route.create(name: 'S', alternate_name: '42 St Shuttle', internal_id: 'GS', color: '6d6e71')
Scheduled::Route.create(name: 'A', internal_id: 'A', color: '2850ad')
Scheduled::Route.create(name: 'B', internal_id: 'B', color: 'ff6319')
Scheduled::Route.create(name: 'C', internal_id: 'C', color: '2850ad')
Scheduled::Route.create(name: 'D', internal_id: 'D', color: 'ff6319')
Scheduled::Route.create(name: 'E', internal_id: 'E', color: '2850ad')
Scheduled::Route.create(name: 'F', internal_id: 'F', color: 'ff6319')
Scheduled::Route.create(name: 'FX', internal_id: 'FX', color: 'ff6319', visible: false)
Scheduled::Route.create(name: 'S', alternate_name: 'Franklin Avenue Shuttle', internal_id: 'FS', color: '6d6e71')
Scheduled::Route.create(name: 'G', internal_id: 'G', color: '6cbe45')
Scheduled::Route.create(name: 'J', internal_id: 'J', color: '996633')
Scheduled::Route.create(name: 'L', internal_id: 'L', color: 'a7a9ac')
Scheduled::Route.create(name: 'M', internal_id: 'M', color: 'ff6319')
Scheduled::Route.create(name: 'N', internal_id: 'N', color: 'fccc0a', text_color: '000000')
Scheduled::Route.create(name: 'Q', internal_id: 'Q', color: 'fccc0a', text_color: '000000')
Scheduled::Route.create(name: 'R', internal_id: 'R', color: 'fccc0a', text_color: '000000')
Scheduled::Route.create(name: 'S', alternate_name: 'Rockaway Park Shuttle', internal_id: 'H', color: '6d6e71')
Scheduled::Route.create(name: 'W', internal_id: 'W', color: 'fccc0a', text_color: '000000')
Scheduled::Route.create(name: 'Z', internal_id: 'Z', color: '996633')
Scheduled::Route.create(name: 'SIR', internal_id: 'SI', color: '0039a6', visible: false)
